...
由于这个特性需要数据库支持SQL标准中的聚合函数的`FILTER`子句，所以不是所有数据库都支持此特性，各主流数据库最新版本实测支持程度如下：
...
// List[
//     (
//         sumCn2024: Option[Int],
//         sumCn2025: Option[Int],
//         sumUs2024: Option[Int],
//         sumUs2025: Option[Int],
//         countCn2024: Long,
//         countCn2025: Long,
//         countUs2024: Long,
//         countUs2025 : Long
